    ...
    <section>
      ...
      <form onSubmit={formik.handleSubmit} className={`max-w-lg my-10 mx-auto border-2 p-4 rounded-lg ${existEmail?"border-red-500 shadow-red-500 ":" border-green-500 shadow-green-500 "} duration-500 shadow-xl`}>
        ...
        <div className="relative z-0 w-full mb-5 group">
          ...
          <div className='flex'>
            {loading?
            <button type="button" className="text-white bg-main hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 rounded-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><VscLoading className='text-xl animate-spin' /></button>
