    ...
    <nav className='md:fixed top-0 inset-x-0 bg-gray-200 text-slate-700 font-medium py-2'>
      <div className="container flex flex-col md:flex-row justify-start md:justify-between items-center gap-2 px-2">
        ...
        <img src={Logo} width={160} alt="" />
          <ul className={`${smallNav ? "flex": "hidden"} md:flex flex-col md:flex-row gap-2`}>
        ...
        <div className={`${smallNav ? "block":"hidden"} md:block min-w-full md:min-w-min`}>
        <ul className='flex flex-col md:flex-row md:items-center gap-2 text-black'>
            <li><FaFacebook /></li>
            <li><FaTwitter/></li>
            <li><FaLinkedin /></li>
            <li><FaInstagram /></li>
