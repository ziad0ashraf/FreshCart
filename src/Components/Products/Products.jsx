                ...
                <div className="cursor-pointer product rounded-lg p-5" key={index}>
                  ...
                  <div className="flex justify-center">
                    {currentId === product.id && loading ? (
                      <button
                        type="button"
                        className="text-white bg-green-700 hover:bg-main focus:ring-4 focus:outline-none focus:ring-green-300 rounded-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                      >
